...
describe('Measurement...', () => {
    test('Can be compared for equality...', () => {
        ...
        //expect(new Measurement(1, "TABLESPOON").equals(new Measurement(2, "TABLESPOON"))).toBe(false)
        //expect(new Measurement(1, "TABLESPOON").equals(new Measurement(1, "TEASPOON"))).toBe(false)
    })
})